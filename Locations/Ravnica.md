...
Once inside the sphere, you're above the 6th District and there are huge creatures that attack anything that flies (leviathans).

The party first arrived on Ravnica via a portal from Sigil on Golgar 18, 9986.
...
- **Xivaskir 20, 9986** - Orevana's date with Donwec
- **Xivaskir 21, 9986** - Fight Club Massacre
- **Xivaskir 27, 9986** - Fashion Show
- **Xivaskir 28, 9986** - Vizkopa Bank Intel-Gathering Mission; Morla's Note in the Mac & Cheese; Rix Maadi Meeting w/Morla
